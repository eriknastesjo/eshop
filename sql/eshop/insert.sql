...
-- CALL insert_produkt_kategori(1,2);

-- CALL show_category();

-- CALL show_new_product_code();


-- CALL show_lagerhylla();

-- CALL show_category();
-- CALL delete_produkt_kategori(1,1);
-- CALL show_category();

CALL show_all_plocklista;
...
-- CALL show_products_categories(3);

-- CALL show_productkod(3);
